  ...
  function doChange() {
    ...
    {
      alert("We Suggest using Microsoft Edge, Chrome or Firefox for better user experience");
    }

  /*  window.onload = function() {
      var mySideBar = document.querySelector('#float-sidebar');
     
      mySideBar.style.opacity = "0.2";
      Stickyfill.add(mySideBar);
